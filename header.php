...
<link rel="stylesheet" href="css/superfish/superfish-vertical.css">
<link rel="stylesheet" href="css/superfish/superfish-navbar.css">
<link rel="stylesheet" href="css/superfish/megafish.css">
<link rel="stylesheet" href="css/colorbox/colorbox.css">
<link rel="stylesheet" type="text/css" href="css/superbox-master/style.css">
  ...
  <div class="container-fluid"> 
    ...
    <div class="collapse navbar-collapse" id="myInverseNavbar2">
      <ul class="nav navbar-nav navbar-right">
         <li><a href="/forma.php">Обратная связь FORMA PHP!!!!!!</a></li>
        <li><a href="/parallax.php">PARALLAX</a></li>
        <li><a href="/Carousel3d.php">Carousel3d.php</a></li>
        <li><a href="/jqueryui-effects.php">Jquery Ui Effects</a></li>
        <li><a href="/jquery-widgets.php">Jquery Widgets</a></li>
        <li><a href="/jquery-interactions.php">Jquery Interactions</a></li>
        <li><a href="/superfish.php">Menu Superfish</a></li>
        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">DropDown<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="/colorbox.php">Galery ColorBox</a></li>
            <li><a href="/superboxTodoMoto.php">SuperBox</a></li>
            <li><a href="/bxslider.php">BxSlider</a></li>
            <li class="divider"></li>
            <li><a href="/wowslider.php">WowSlider</a></li>
          </ul>
        </li>
      </ul>
    </div>
